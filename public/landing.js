...
`
  ...
  // src/client/shader.ts
  var VERT = `
attribute vec2 a_pos;
void main() { gl_Position = vec4(a_pos, 0.0, 1.0); }
`;
  function initShader(canvas2, initialTheme) {
    ...
    function startLoop() {
      ...
      function frame(ms) {
        gl.uniform1f(uTime, ms * 1e-3);
        gl.uniform2f(uResolution, canvas2.width, canvas2.height);
